...
** Open the Shopping Application "Admin" Page https://camel-edge-{user}-lab2-edge.apps.{openshift_cluster_ingress_domain}/[https://camel-edge-{user}-lab2-edge.apps.{openshift_cluster_ingress_domain}/]
...
* The Shopping service will next call the Price Engine *price-engine* and return the current price.  The Pricing Engine was reviewed in xref:02-02-appdev-edge-camel-price.adoc[Pricing Engine Section]
